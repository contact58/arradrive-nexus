...
{
  icon: MapPin,
  title: "Gare d'Arras ↔ Aéroport Lesquin",
  description: "Navette fiable et ponctuelle entre la gare et l'aéroport, disponible 7j/7."
},
{
  icon: Clock,
  title: "Disponible 24h/24",
  description: "Un chauffeur à votre disposition à toute heure, pour tous vos déplacements."
},
{
  icon: Shield,
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          <h1 className="sr-only">Taxi Arras - Les Chauffeurs d'Arras, service de transport fiable à Arras</h1>
          <motion.p
            initial={{ opacity: 0, y: -10 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
            className="text-sm font-medium tracking-widest uppercase text-primary mb-6">RÉSERVATION URGENTE ? 06 09 50 15 57
          ...
          <motion.p
            ...
            Service de transport fiable, efficace et disponible à Arras et dans tout le Pas-de-Calais. Réservez votre trajet en quelques clics.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
